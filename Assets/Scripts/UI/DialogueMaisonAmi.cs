...
public class DialogueMaisonAmi : MonoBehaviour
{
    ...
    public void ChoiceOption1_Dialogue1()
    {
        ...
        TextBox.GetComponent<Text>().text = "Où veut tu laisser le colis ?";
    ...
    {
        GameManager.Instance.QuestStep = "1.1.1";
        Debug.Log("questStep : " + GameManager.Instance.QuestStep);

        TextBox.GetComponent<Text>().text = "Ok c'est bon à été déposer chez ton ami";
        Choice01.SetActive(false);
        Choice02.SetActive(false);
        Choice03.SetActive(false);
        Choice04.SetActive(false);
    ...
    {
        GameManager.Instance.QuestStep = "1.1.2";
        Debug.Log("questStep : " + GameManager.Instance.QuestStep);

        TextBox.GetComponent<Text>().text = "Tu as choisi le bon fil, tu as donc réussi à couper l'éléctricité";
        Choice01.SetActive(false);
        Choice02.SetActive(false);
        Choice03.SetActive(false);
        Choice04.SetActive(false);
