...
public class DialogueCompteurElectrique : MonoBehaviour
{
    ...
    public void ChoiceOption1_Dialogue1()
    {
        ...
        TextBox.GetComponent<Text>().text = "Quel fil veut-tu couper ?";
    ...
    {
        GameManager.Instance.QuestStep = "2.1.1";
        Debug.Log("questStep : " + GameManager.Instance.QuestStep);

        TextBox.GetComponent<Text>().text = "Tu n'as pas couper le bon fil";
        Choice01.SetActive(false);
        Choice02.SetActive(false);
        Choice03.SetActive(false);
        Choice04.SetActive(false);
    ...
    {
        GameManager.Instance.QuestStep = "2.1.2";
        Debug.Log("questStep : " + GameManager.Instance.QuestStep);
